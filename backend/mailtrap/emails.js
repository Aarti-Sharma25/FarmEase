...
//     }
// };
// import { getTransporter, getSender } from "./mailtrap.config.js";

// export const sendVerificationEmail = async (email, verificationToken) => {
//     const transporter = getTransporter();  // ✅ ab function call hoga jab email bhejni hogi
//     const sender = getSender();

//     const mailOptions = {
//         from: sender.email,   // note: 'from' string chahiye hota hai, object nahi
//         to: email,
//         subject: "Welcome to FarmEase - Please Verify Your Email",
//         html: VERIFICATION_EMAIL_TEMPLATE.replace("{verificationCode}", verificationToken),
//     };
...
// // };
// import { PASSWORD_RESET_REQUEST_TEMPLATE, VERIFICATION_EMAIL_TEMPLATE, PASSWORD_RESET_SUCCESS_TEMPLATE } from "./emailTemplates.js";
// import { getResendClient, getSender } from "./mailtrap.config.js";
...
export const sendVerificationEmail = async (email, verificationToken) => {
    ...
    sendSmtpEmail.subject = "Welcome to FarmEase - Please Verify Your Email";
...
export const sendWelcomeEmail = async (email, name) => {
    ...
    const sendSmtpEmail = new brevo.SendSmtpEmail();
    sendSmtpEmail.subject = "Welcome to FarmEase - Let's Grow Together!";
...
export const sendPasswordResetEmail = async (email, resetURL) => {
    ...
    const sendSmtpEmail = new brevo.SendSmtpEmail();
    sendSmtpEmail.subject = "FarmEase - Reset Your Password";
...
export const sendResetSuccessEmail = async (email) => {
    ...
    const sendSmtpEmail = new brevo.SendSmtpEmail();
    sendSmtpEmail.subject = "FarmEase - Password Updated Successfully";
