...
import { fileURLToPath } from 'url';
import { dirname } from 'path';
import { addRental, getRentals, deleteRental, searchRentals } from '../controllers/rental.controller.js';
import fs from 'fs';
...
// Route for semantic search — must be defined as its own path, doesn't clash with '/'
